      ...
      try {
        ...
        const activityDurationMetrics = Array.from(activityDurations.entries())
          .map(([activity, durations]) => {
            ...
            const avgDuration =
              durations.reduce((sum: any, duration: any) => sum + duration, 0) /
              durations.length;
    ...
    <DashboardLayout>
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Detailed performance metrics and bottleneck analysis based on real CSV
          data
        </p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="prose max-w-none">
              <p>
                Analysis of the process performance metrics reveals several key
                insights:
              </p>

              <ul className="list-disc pl-5 space-y-2 mt-2">
                <li>
                  <span className="font-medium">Bottlenecks:</span> The Clear
                  Invoice activity has the longest duration at 5.2 days on
                  average, representing a key opportunity for process
                  improvement.
                </li>
                <li>
                  <span className="font-medium">Process Efficiency:</span> The
                  average lead time is{" "}
                  {performanceMetricsData[0]?.metrics[0]?.value || "N/A"}, with
                  significant variation across different companies and regions.
                </li>
                <li>
                  <span className="font-medium">Process Quality:</span> The
                  on-time delivery rate is{" "}
                  {performanceMetricsData[2]?.metrics[0]?.value || "N/A"},
                  indicating good overall performance but with room for
                  improvement.
                </li>
                <li>
                  <span className="font-medium">Activity Duration:</span> The
                  Create Delivery and Create Shipment activities have the
                  highest variability in duration, suggesting inconsistent
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  Focus on reducing the duration of the Clear Invoice activity
                  to improve overall process efficiency.
                </li>
                <li>
                  Standardize the Create Delivery and Create Shipment processes
                  to reduce variability.
                </li>
                <li>
                  Investigate the causes of delays in the Asia-Pacific region,
                  which has longer lead times compared to Europe.
                </li>
                <li>
                  Implement automated notifications for invoices pending
