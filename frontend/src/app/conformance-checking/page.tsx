      ...
      try {
        ...
        const materialGroupConformance = Array.from(materialGroupMap.entries())
          .map(([group, stats]) => {
            const rate =
              stats.total > 0
                ? Math.round((stats.conformant / stats.total) * 100)
                : 0;
            return {
              group,
              total: stats.total,
              ...
              rate,
              impact:
                rate >= 70 ? "positive" : rate >= 50 ? "neutral" : "negative",
            };
          })
    ...
    <DashboardLayout>
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Analysis of process conformance, deviations, and conformance by
          different dimensions using real CSV data
        </p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="prose max-w-none">
              <p>
                Analysis of the process conformance reveals several key
                insights:
              </p>
              ...
              {conformanceByGroup && (
                <ul className="list-disc pl-5 space-y-2 mt-2">
                  ...
                  <li>
                    <span className="font-medium">Common Deviations:</span>{" "}
                    Price changes and material changes are the most common
                    deviations, accounting for{" "}
                    {conformanceData?.deviations?.[0]?.percentage || 0}% and{" "}
                    {conformanceData?.deviations?.[1]?.percentage || 0}% of
                    cases respectively.
                  </li>
                </ul>
              )}
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  Standardize pricing processes to reduce the need for price
                  changes after sales order creation.
                </li>
                <li>
                  Improve material selection accuracy during initial order entry
                  to reduce material changes.
                </li>
                <li>
                  Share best practices from high-conformance companies with
                  lower-performing entities.
                </li>
                <li>
                  Implement automated validation checks to prevent common
                  deviations.
                </li>
              </ul>
            </div>
